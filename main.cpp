...
m1 db "Enter the five 64 bit numbers:" ,10 ; 10d -> line feed 
 ...
 m3 db "Exp first" ,10 
 l3 equ $-m3 
 m4 db "Write an X86/64 ALP to accept five 64 bit Hexadecimal numbers from user and store them
in an array and display the accepted numbers." ,10d 
 l4 equ $-m4
...
mov rdi,0
syscall
3/10/23, 10:22 AM https://lms.tssm.edu.in/pluginfile.php/34123/mod_resource/content/0/Exp 1.asm
https://lms.tssm.edu.in/pluginfile.php/34123/mod_resource/content/0/Exp 1.asm 2/2
error:
 IO 1,1,m6,l6
 jmp exit
ascii_to_hex:
